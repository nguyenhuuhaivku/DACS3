        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    // 'icon' => 'fas fa-th',
                    'icon_color' => 'grey',
                    // 'onclick' => "loadTabContent('/admin/table/layout')",
                ],
                [
                    'text' => 'Lịch đặt bàn',
                    ...
                    'icon_color' => 'grey',
                    // 'onclick' => "loadTabContent('/admin/reservations/schedule')",
                ],
                [
                    ...
                    // 'icon' => 'fas fa-history',
                    'icon_color' => 'grey',
                    // 'onclick' => "loadTabContent('/admin/reservations/history')",
                ],
            ],
        ],
        ['text' => 'Quản lý đơn mang về',
            'icon' => 'fas fa-box',
            'submenu' => [
                [
                    'text' => 'Đơn hàng hiện tại',
                    'url' => 'admin/takeaway-orders/current',
                    // 'icon' => 'fas fa-box-open',
                    'icon_color' => 'grey',
                ],
                [
                    'text' => 'Đơn hàng đã hoàn tất',
                    'url' => 'admin/takeaway-orders/completed',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url' => 'admin/invoices/current',
                    // 'icon' => 'fas fa-file-invoice-dollar',
                    'icon_color' => 'grey',
                ],
                [
                    'text' => 'Hóa đơn đã hoàn tất',
                    'url' => 'admin/invoices/completed',
                    // 'icon' => 'fas fa-check',
                    'icon_color' => 'grey',
                ],
            ],
